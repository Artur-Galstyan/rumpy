...
pub fn sum(a: &Array) -> f64 {
    // TODO (historical, completed): Reduce all values in flat order.
    // Starting at +0 also handles empty arrays and scalar negative zero.
    let mut total = 0.0_f64;
    // Traverse storage, not axis lengths. No shape product or allocation is needed.
